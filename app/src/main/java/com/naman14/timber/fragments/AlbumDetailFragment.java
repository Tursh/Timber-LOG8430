...
public class AlbumDetailFragment extends Fragment {
    ...
    private void setAlbumart() {
        ImageUtils.loadAlbumArtIntoView(album.id, albumArt, new AlbumImageLoadingListener());
    }
    ...
    class AlbumImageLoadingListener implements ImageLoadingListener {
        ...
        public void onLoadingComplete(String imageUri, View view, Bitmap loadedImage) {
            try {
                new Palette.Builder(loadedImage).generate(new AlbumArtPaletteListener());
    ...
    class AlbumArtPaletteListener implements Palette.PaletteAsyncListener {
        @Override
